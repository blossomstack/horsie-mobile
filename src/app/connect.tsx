...
export default function Connect() {
  ...
  const begin = useCallback(async () => {
    ...
    try {
      ...
      void WebBrowser.openBrowserAsync(code.verificationUriComplete);
        ...
        {stage.kind === "url" ? (
          ...
          <>
            ...
            <Button
              ...
              variant="secondary"
              onPress={() =>
                void WebBrowser.openBrowserAsync(stage.code.verificationUriComplete)
              }
            />
            <Button
              label="Start over"
